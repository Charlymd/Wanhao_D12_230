 ...
 * and BL Touch
 * 
 * Each specific line is comment with "# Custom config"
 */
#pragma once
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
  // custom config
    #define DEFAULT_Kp 18.67 //22.20
    #define DEFAULT_Ki  1.08
    #define DEFAULT_Kd 80.53 //114.00
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 92.32 //13.00
  #define DEFAULT_bedKi 17.62 //.023
  #define DEFAULT_bedKd 120.95 //305.4
